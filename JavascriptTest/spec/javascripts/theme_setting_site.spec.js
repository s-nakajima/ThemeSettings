describe('theme_setting_site', function() {
  ...
  beforeEach(inject(function($controller) {
    //spec body
    scope = {};
    var ThemeSettingsSiteIndexCtrl = $controller('ThemeSettingsSiteIndexCtrl',
        { $scope: scope });
  ...
  it('strimwidth()', inject(function($controller) {
    ...
    var text = 'test1test1test1test1test1test1test1test1test1test1test1test' +
        '1test1test1test1test1test1test1test1test1test1';
    var resolt = 'test1test1test1test1test1test1test1test1test1test1test1tes' +
        't1test1test1test1test1test1test1test1test1...';
  }));
